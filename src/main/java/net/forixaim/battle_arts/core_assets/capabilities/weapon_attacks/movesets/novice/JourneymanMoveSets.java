...
public class JourneymanMoveSets
{
    public static final MoveSetEntry JOURNEYMAN_AXE = new MoveSetEntry(
            ...
            MoveSet.builder()
                    ...
                    .addInnateSkill((itemStack, playerPatch) -> SkillRegistry.RECURVE_AXE.get())
    );
    ...
    public static final MoveSetEntry JOURNEYMAN_BATTLE_AXE = new MoveSetEntry(
            ...
            MoveSet.builder()
                    ...
                    .addInnateSkill((itemStack, playerPatch) -> SkillRegistry.SEISMIC_IMPACT.get())
    );
    ...
    public static final MoveSetEntry JOURNEYMAN_UNARMED = new MoveSetEntry(
            ...
            MoveSet.builder()
                    ...
                    .addInnateSkill((itemStack, playerPatch) -> SkillRegistry.SUPPRESSING_BLOW.get())
    );
}
