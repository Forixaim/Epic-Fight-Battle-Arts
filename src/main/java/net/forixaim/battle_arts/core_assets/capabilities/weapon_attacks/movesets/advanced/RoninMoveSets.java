...
public class RoninMoveSets
{
    ...
    public static final MoveSetEntry RONIN_UCHIGATANA = new MoveSetEntry(
            ...
            MoveSet.builder()
                    ...
                    .addInnateSkill((itemStack, playerPatch) -> Ronin.TRANQUILITY)
    );
    ...
    public static final MoveSetEntry RONIN_UCHIGATANA_SHEATHED = new MoveSetEntry(
            ...
            MoveSet.builder()
                    ...
                    .addLivingMotionsRecursive(
                            ...
                            LivingMotions.IDLE, LivingMotions.WALK, LivingMotions.JUMP, LivingMotions.CHASE, LivingMotions.SWIM, LivingMotions.RUN
                    )
