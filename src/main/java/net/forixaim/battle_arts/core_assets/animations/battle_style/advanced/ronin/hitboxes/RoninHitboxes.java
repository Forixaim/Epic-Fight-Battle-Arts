...
{
    public static final Collider BLOSSOM_SLASH = registerCollider(ResourceLocation.fromNamespaceAndPath(EpicFightBattleArts.MOD_ID, "blossom_slash"), new OBBCollider(3, 3, 3, 0, 0, 0));
