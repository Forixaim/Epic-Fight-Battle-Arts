...
public class LancerSpearAnimations
{
    ...
    public static AnimationManager.AnimationAccessor<KnockbackComboAttackAnimation> AUTO3;
    public static AnimationManager.AnimationAccessor<KnockbackComboAttackAnimation> DASH;
    public static AnimationManager.AnimationAccessor<KnockbackComboAttackAnimation> AIRSLASH;
    ...
    public static void build(AnimationManager.AnimationBuilder builder)
    {
        ...
        GUARD = builder.nextAccessor("battle_style/advanced/lancer/spear/guard", access -> new StaticAnimation(0.2f, true, access, Armatures.BIPED));

        GUARD_HIT = builder.nextAccessor("battle_style/advanced/lancer/spear/guard_hit", access -> new GuardAnimation(0.2f, access, Armatures.BIPED));
        ...
        AUTO3 = builder.nextAccessor("battle_style/advanced/lancer/spear/auto3", access ->
                new KnockbackComboAttackAnimation(0.2f, 0.0f, 0.75f, 0.9f, 2f, null, Armatures.BIPED.get().toolR, access, Armatures.BIPED)
        ...
        DASH = builder.nextAccessor("battle_style/advanced/lancer/spear/dash", access ->
                new KnockbackComboAttackAnimation(0.2f, 0.0f, 0.2f, 0.3f, 2f, null, Armatures.BIPED.get().toolR, access, Armatures.BIPED)
        ...
        AIRSLASH = builder.nextAccessor("battle_style/advanced/lancer/spear/airslash", access ->
                new KnockbackComboAttackAnimation(0.1f, 0.0f, 0.1f, 0.4f, 2f, null, Armatures.BIPED.get().toolR, access, Armatures.BIPED)
        ...
        DASHING_IMPALE = builder.nextAccessor("battle_style/advanced/lancer/spear/dashing_impale", access ->
                new KnockbackAttackAnimation(0.1f, 0.0f, 0.3f, 0.4f, 2f, null, Armatures.BIPED.get().toolR, access, Armatures.BIPED)
                        .addProperty(BattleArtsAttackPhaseProperties.KNOCKBACK_ANGLE, 30d)
                        .addProperty(BattleArtsAttackPhaseProperties.KNOCKBACK_POWER, 1.2d)
                        .addProperty(AnimationProperty.StaticAnimationProperty.PLAY_SPEED_MODIFIER, (dynamicAnimation, livingEntityPatch, v, v1, v2) ->
                                v * 0.6f));
