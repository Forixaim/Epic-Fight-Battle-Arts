...
public class JourneymanBattleAxeAnims
{
    ...
    public static AnimationManager.AnimationAccessor<ComboAttackAnimation> JMAN_BAXE_AUTO_1;
    public static AnimationManager.AnimationAccessor<ComboAttackAnimation> JMAN_BAXE_AUTO_2;
    ...
    public static void Build(AnimationManager.AnimationBuilder event)
    {
        ...
        JMAN_BAXE_AUTO_1 = event.nextAccessor(JourneymanAnimations.jmanAnimationPath(BattleStyleCategories.BATTLE_AXE, "auto1"), accessor ->
                new ComboAttackAnimation(0.2f, 0.0f, 0.4f, 0.6f, 1.0f, null,
        ...
        JMAN_BAXE_AUTO_2 = event.nextAccessor(JourneymanAnimations.jmanAnimationPath(BattleStyleCategories.BATTLE_AXE, "auto2"), accessor -> new ComboAttackAnimation(0.5f, 0.0f, 0.55f, 0.65f, 2.0f, null, Armatures.BIPED.get().toolR, accessor, Armatures.BIPED)
        ...
        SEISMIC_IMPACT = event.nextAccessor(JourneymanAnimations.jmanAnimationPath(BattleStyleCategories.BATTLE_AXE, "seismic_impact"),
                access -> new AirSlashAnimation(0.5f, access, Armatures.BIPED,
                        ...
                        new AttackAnimation.Phase(1.6f, 0.0f, 1.6f, 1.7f, 3.0f, 4.0f, Armatures.BIPED.get().rootJoint, JourneymanHitboxes.SEISMIC_IMPACT)
                                ...
                                .addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, SoundEvents.GENERIC_EXPLODE.value())
