...
public class KnockbackComboAttackAnimation extends ComboAttackAnimation
{

    public KnockbackComboAttackAnimation(float transitionTime, float antic, float preDelay, float contact, float recovery, @Nullable Collider collider, Joint colliderJoint, AnimationManager.AnimationAccessor<KnockbackComboAttackAnimation> accessor, AssetAccessor<? extends Armature> armature) {
    ...
    public KnockbackComboAttackAnimation(float transitionTime, AnimationManager.AnimationAccessor<? extends ComboAttackAnimation> accessor, AssetAccessor<? extends Armature> armature, Phase... phases) {
    ...
    public KnockbackComboAttackAnimation(float convertTime, String path, AssetAccessor<? extends Armature> armature, Phase... phases) {
