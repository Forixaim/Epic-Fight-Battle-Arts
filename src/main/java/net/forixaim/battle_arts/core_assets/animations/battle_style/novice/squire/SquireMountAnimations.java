...
public class SquireMountAnimations
{
    ...
    public static void build(AnimationManager.AnimationBuilder builder)
    {
        ...
        AUTO1 = builder.nextAccessor("battle_style/novice/squire/mounted/auto1", access -> new BasicAttackAnimation(0.2f, 0.0f, 0.6f, 0.7f, 0.8f, null, Armatures.BIPED.get().toolR, access, Armatures.BIPED));
        AUTO2 = builder.nextAccessor("battle_style/novice/squire/mounted/auto2", access -> new BasicAttackAnimation(0.2f, 0.0f, 0.35f, 0.5f, 1.5f, null, Armatures.BIPED.get().toolR, access, Armatures.BIPED));
    }
}
