...
public class SkillRegistry
{
    ...
    public static final DeferredHolder<Skill, SimpleWeaponInnateSkill> DISEMBOWELMENT = SKILLS.register("disembowelment", key -> SimpleWeaponInnateSkill.createSimpleWeaponInnateBuilder().setAnimations(SquireDaggerAnimations.DISEMBOWELMENT).newProperty().build(key));
